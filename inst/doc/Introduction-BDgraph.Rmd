...
* Birth-death MCMC (BDMCMC) sampling algorithms desciribed in [Mohammadi et al. (2021)](https://doi.org/10.1080/01621459.2021.1996377) and [Mohammadi and Wit (2015)](https://projecteuclid.org/euclid.ba/1422468425).
* Reversible jump MCMC (RJMCMC) sampling algorithms desciribed in [Dobra et al. (2011)](https://doi.org/10.1198/jasa.2011.tm10465). 
* Hill-climbing (HC) search algorithm desciribed in [Pensar et al. (2017)](https://doi.org/10.1214/16-ba1032).  
