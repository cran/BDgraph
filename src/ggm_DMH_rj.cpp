...
*/
void rjmcmcExactp_links_DMH( int *iter, int *burnin, int G[], double Ts[], double Ti[], double K[], int *p, 
...
*/
void rjmcmc_DMH( int *iter, int *burnin, int G[], double Ts[], double Ti[], double K[], int *p, 
