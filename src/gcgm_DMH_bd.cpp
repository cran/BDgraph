...
void bdmcmcCopulap_links_DMH( int *iter, int *burnin, int G[], double Ts[], double Ti[], double K[], int *p, 
...
*/
void bdmcmcCopula_DMH( int *iter, int *burnin, int G[], double Ts[], double Ti[], double K[], int *p, 
			 double Z[], int R[], int *n, int *gcgm,
